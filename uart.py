        ...
        while True:
            ...
            try:
                if False == self.cur_self.recv_queue.empty():
                    ...
                    print("Uart_Recv_Data_Thread show_data is {}" .format(show_data))
                    self.cur_self.protol_recv_queue.put(show_data)
...
class Uart(object):
    def __init__(self, parent):
        ...
        self.uart_rec_hex_lock = 1


    def uart_init(self, port, baud, stopbit, databit, checkbit,protol_recv_queue):
        try:
            ...
            self.protol_recv_queue = protol_recv_queue
            # 创建线程
